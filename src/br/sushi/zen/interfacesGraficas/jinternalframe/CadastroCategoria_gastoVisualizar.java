...
import static br.sushi.zen.interfacesGraficas.frames.JanelaPrincipal.internalFrameCadastroCategoria_gastoVisualizar;
 ...
 * @author Cesar Schutz
 */
public class CadastroCategoria_gastoVisualizar extends javax.swing.JInternalFrame implements JanelaVisualizar<Categoria_gasto> {

    Categorias_gasto categoria_gastosDao = new Categorias_gasto();
    ArrayList<Categoria_gasto> listaCategorias_gasto = new ArrayList<>();

    /**
     * DEFAULT CONSTRUCTOR
     */
    public CadastroCategoria_gastoVisualizar() {
        super("Categorias de Gasto", true, true, false, true);
        initComponents();
        ...
        preencheTabela(listaCategorias_gasto = categoria_gastosDao.listar());
    ...
    public void doDefaultCloseAction() {
        JanelaPrincipal.internalFrameCadastroCategoria_gastoVisualizar.dispose();
        JanelaPrincipal.internalFrameCadastroCategoria_gastoVisualizar = null;
    }

    @Override
    public final void preencheTabela(ArrayList<Categoria_gasto> lista) {
        //limpa tabela
        ...
        if (lista != null) {
            for (Categoria_gasto categoria_gasto : lista) {
                modelo.addRow(new Object[]{categoria_gasto, categoria_gasto.getNome()});
            }
        }
    }
    ...
    public void botaoNovo() {
        ...
        JanelaPrincipal.internalFrameCadastroCategoria_gasto = new CadastroCategoria_gasto();
        JanelaPrincipal.abrirInternalFrame(JanelaPrincipal.internalFrameCadastroCategoria_gasto);
    }

    @Override
    public void clicaTabela(Categoria_gasto categoria_gasto) {
        doDefaultCloseAction();
        JanelaPrincipal.internalFrameCadastroCategoria_gasto = new CadastroCategoria_gasto(categoria_gasto);
        JanelaPrincipal.abrirInternalFrame(JanelaPrincipal.internalFrameCadastroCategoria_gasto);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisa Categoria de Gasto por Nome: ");
    ...
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        clicaTabela((Categoria_gasto) jTable1.getValueAt(jTable1.getSelectedRow(), 0));
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        if ("".equals(jTextField2.getText())) {
            preencheTabela(listaCategorias_gasto);
        } else {
            //limpa tabela
            ((DefaultTableModel) jTable1.getModel()).setNumRows(0);
            jTable1.updateUI();
            ...
            if (listaCategorias_gasto != null) {
                for (Categoria_gasto categoria_gasto : listaCategorias_gasto) {
                    if (categoria_gasto.getNome().contains(jTextField2.getText())) {
                        modelo.addRow(new Object[]{categoria_gasto, categoria_gasto.getNome()});
                    }
                }
            }
